...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			diamond = FlxGraphic.fromClass(GraphicTransTileDiamond);
	...
	override function update(elapsed:Float)
	{
		...
		colorshadertimer += elapsed;

		if (colorshadertimer > 5 && skippedIntro)
			swagShader.update(-elapsed * 0.1);


		super.update(elapsed);
	}
	var colorshadertimer:Float = 0;
