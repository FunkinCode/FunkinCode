...
class StoryMenuState extends MusicBeatState
{
	...
	var grpWeekText:FlxTypedGroup<MainMenuItem>;
	...
	override function create()
	{
		...
		grpWeekText = new FlxTypedGroup<MainMenuItem>();
		add(grpWeekText);
		...
		{
			var weekThing:MainMenuItem = new MainMenuItem(0, yellowBG.y + yellowBG.height + 10, i);
